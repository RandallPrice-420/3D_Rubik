...
public class BigCube : MonoBehaviour
{
    ...
    public bool CheckWinCondition()
    {
        ...
        {
            if (cubelet.direction == CubeletDirection.South ) southColor  = cubelet.color;
            if (cubelet.direction == CubeletDirection.North ) northColor  = cubelet.color;
            if (cubelet.direction == CubeletDirection.East  ) eastColor   = cubelet.color;
            if (cubelet.direction == CubeletDirection.West  ) westColor   = cubelet.color;
            if (cubelet.direction == CubeletDirection.Top   ) topColor    = cubelet.color;
            if (cubelet.direction == CubeletDirection.Bottom) bottomColor = cubelet.color;
        }

        foreach (Cubelet cubelet in cubelets)
        {
            if (cubelet.direction == CubeletDirection.South ) if (cubelet.color != southColor ) return false;
            if (cubelet.direction == CubeletDirection.North ) if (cubelet.color != northColor ) return false;
            if (cubelet.direction == CubeletDirection.East  ) if (cubelet.color != eastColor  ) return false;
            if (cubelet.direction == CubeletDirection.West  ) if (cubelet.color != westColor  ) return false;
            if (cubelet.direction == CubeletDirection.Top   ) if (cubelet.color != topColor   ) return false;
            if (cubelet.direction == CubeletDirection.Bottom) if (cubelet.color != bottomColor) return false;
        }
